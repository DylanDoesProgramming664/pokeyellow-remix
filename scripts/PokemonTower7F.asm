...
IF DEF(_DEBUG)
	...
	ret nz
ENDC
	CheckEvent EVENT_BEAT_POKEMONTOWER7F_TRAINER_0
...
PokemonTower7FScript_60d2a:
	...
	cp $c
	ret nz
	ResetEvent EVENT_BEAT_POKEMONTOWER7F_TRAINER_1
	ld a, [wXCoord]
	cp $a
	jr z, .asm_60d47
	ld a, [wXCoord] ; why?
	cp $b
	ret nz
	SetEvent EVENT_BEAT_POKEMONTOWER7F_TRAINER_1
.asm_60d47
	call StopAllMusic
...
PokemonTower7FScript1:
	...
	CheckEvent EVENT_BEAT_POKEMONTOWER7F_TRAINER_1
	jr z, .asm_60d8c
...
PokemonTower7FScript10:
	...
	ldh [hJoyHeld], a
	ld [wJoyIgnore], a
	SetEvent EVENT_BEAT_POKEMONTOWER7F_TRAINER_0
