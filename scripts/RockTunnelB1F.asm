...
RockTunnelB1FTrainerHeaders:
	def_trainers ROCK_TUNNEL_B1F_TRAINER_EVENT_OFFSET ; replaced by def_trainers_sub.py
RockTunnelB1FTrainerHeader0:
	trainer EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_0, 3, RockTunnelB1FCooltrainerF1BattleText, RockTunnelB1FCooltrainerF1EndBattleText, RockTunnelB1FCooltrainerF1AfterBattleText
...
RockTunnelB1FTrainerHeader7:
	trainer EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_7, 2, RockTunnelB1FSuperNerd3BattleText, RockTunnelB1FSuperNerd3EndBattleText, RockTunnelB1FSuperNerd3AfterBattleText
	db -1 ; end
