...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_FLASH_CANNON, TM_MIMIC, TM_METRONOME, TM_SHADOW_CLAW, TM_SKULL_BASH, TM_PSYWAVE, TM_TRI_ATTACK
