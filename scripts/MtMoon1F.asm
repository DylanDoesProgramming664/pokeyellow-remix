...
MtMoon1TrainerHeaders:
	def_trainers MT_MOON1F_TRAINER_EVENT_OFFSET ; replaced by def_trainers_sub.py
MtMoon1TrainerHeader0:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_0, 2, MtMoon1FHikerBattleText, MtMoon1FHikerEndBattleText, MtMoon1FHikerAfterBattleText
MtMoon1TrainerHeader1:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_1, 3, MtMoon1FYoungster1BattleText, MtMoon1FYoungster1EndBattleText, MtMoon1FYoungster1AfterBattleText
MtMoon1TrainerHeader2:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_2, 3, MtMoon1FCooltrainerF1BattleText, MtMoon1FCooltrainerF1EndBattleText, MtMoon1FCooltrainerF1AfterBattleText
MtMoon1TrainerHeader3:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_3, 3, MtMoon1FSuperNerdBattleText, MtMoon1FSuperNerdEndBattleText, MtMoon1FSuperNerdAfterBattleText
MtMoon1TrainerHeader4:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_4, 3, MtMoon1FCooltrainerF2BattleText, MtMoon1FCooltrainerF2EndBattleText, MtMoon1FCooltrainerF2AfterBattleText
MtMoon1TrainerHeader5:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_5, 3, MtMoon1FYoungster2BattleText, MtMoon1FYoungster2EndBattleText, MtMoon1FYoungster2AfterBattleText
MtMoon1TrainerHeader6:
	trainer EVENT_BEAT_MT_MOON1F_TRAINER_6, 3, MtMoon1FYoungster3BattleText, MtMoon1FYoungster3EndBattleText, MtMoon1FYoungster3AfterBattleText
	db -1 ; end
