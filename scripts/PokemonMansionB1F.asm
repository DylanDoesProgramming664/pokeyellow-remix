...
Mansion4TrainerHeaders:
	def_trainers POKEMONMANSION_B1F_TRAINER_EVENT_OFFSET ; replaced by def_trainers_sub.py
Mansion4TrainerHeader0:
	trainer EVENT_BEAT_POKEMONMANSION_B1F_TRAINER_0, 0, PokemonMansionB1FBurglarBattleText, PokemonMansionB1FBurglarEndBattleText, PokemonMansionB1FBurglarAfterBattleText
Mansion4TrainerHeader1:
	trainer EVENT_BEAT_POKEMONMANSION_B1F_TRAINER_1, 3, PokemonMansionB1FScientistBattleText, PokemonMansionB1FScientistEndBattleText, PokemonMansionB1FScientistAfterBattleText
MewTrainerHeader:
