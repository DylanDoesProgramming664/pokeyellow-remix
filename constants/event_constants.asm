...
DEF VIRIDIAN_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Pewter City events
	...
	const_skip 8
DEF PEWTER_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_PEWTER_GYM_TRAINER_0
	const_skip 3
	const EVENT_GOT_TM34
	const EVENT_BEAT_BROCK
	const EVENT_BOUGHT_PEWTERPOKECENTER_SALESMAN_POKEMON
...
; Cerulean City events
	...
	const_skip 17
DEF CERULEAN_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Lavender Town events
	...
	const_skip 1
DEF POKEMONTOWER3F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONTOWER3F_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER3F_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER3F_TRAINER_2
	const_skip 5
DEF POKEMONTOWER4F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONTOWER4F_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER4F_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER4F_TRAINER_2
	const_skip 6
DEF POKEMONTOWER5F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONTOWER5F_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER5F_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER5F_TRAINER_2
	const EVENT_BEAT_POKEMONTOWER5F_TRAINER_3
	const_skip 1
	const EVENT_IN_PURIFIED_ZONE
	const_skip 1
DEF POKEMONTOWER6F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONTOWER6F_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER6F_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER6F_TRAINER_2
	const EVENT_BEAT_POKEMONTOWER6F_ROCKET_JERRY
	const_skip 2
	const EVENT_BEAT_GHOST_MAROWAK
	const_skip 1
DEF POKEMONTOWER7F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONTOWER7F_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER7F_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER7F_TRAINER_2
	const_skip 3
...
DEF VERMILION_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF CELADON_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF FUCHSIA_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Cinnabar Island events
	...
	const_skip 16
DEF POKEMONMANSION_1F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONMANSION_1F_TRAINER_0
	const EVENT_BEAT_POKEMONMANSION_2F_OAK
	const_skip 13
...
DEF FIGHTING_DOJO_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF SAFFRON_GYM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 3 events
	const_next $3E0
	const_skip 2
DEF ROUTE_3_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 4 events
	const_next $3F0
	const_skip 2
DEF ROUTE_4_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 6 events
	const_next $410
	const_skip 1
DEF ROUTE_6_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 8 events
	const_next $430
	const_skip 1
DEF ROUTE_8_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 9 events
	const_next $440
	const_skip 1
DEF ROUTE_9_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 10 events
	const_next $450
	const_skip 1
DEF ROUTE_10_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const EVENT_BEAT_ROUTE_10_ROCKET_JERRY
	const_skip 1
DEF ROCK_TUNNEL_1_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 1
DEF POWER_PLANT_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 11 events
	const_next $470
	const_skip 1
DEF ROUTE_11_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const EVENT_BEAT_ROUTE_11_TRAINER_10
	const EVENT_BEAT_ROUTE_11_TRAINER_11
	const_skip 2
...
; Route 12 events
	...
	const_skip 1
DEF ROUTE_12_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 13 events
	const_next $490
	const_skip 1
DEF ROUTE_13_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 14 events
	const_next $4A0
	const_skip 1
DEF ROUTE_14_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF ROUTE_15_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 16 events
	const_next $4C0
	const_skip 1
DEF ROUTE_16_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 17 events
	const_next $4D0
	const_skip 1
DEF ROUTE_17_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 18 events
	const_next $4E0
	const_skip 1
DEF ROUTE_18_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 19 events
	const_next $4F0
	const_skip 1
DEF ROUTE_19_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF ROUTE_20_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Route 21 events
	const_next $510
	const_skip 1
DEF ROUTE_21_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF VICTORY_ROAD_2_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF ROUTE_24_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF ROUTE_25_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Viridian Forest events
	const_next $560
	const_skip 2
DEF VIRIDIAN_FOREST_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Mt. Moon events
	const_next $570
	const_skip 1
DEF MT_MOON1F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_MT_MOON1F_TRAINER_0
	const EVENT_BEAT_MT_MOON1F_TRAINER_1
	const EVENT_BEAT_MT_MOON1F_TRAINER_2
	const EVENT_BEAT_MT_MOON1F_TRAINER_3
	const EVENT_BEAT_MT_MOON1F_TRAINER_4
	const EVENT_BEAT_MT_MOON1F_TRAINER_5
	const EVENT_BEAT_MT_MOON1F_TRAINER_6
	const EVENT_GOT_DOME_FOSSIL
	const EVENT_BEAT_MT_MOON_EXIT_SUPER_NERD
	const EVENT_BEAT_MT_MOONB2F_TRAINER_0
DEF MT_MOONB2F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_MT_MOONB2F_TRAINER_1
	const EVENT_BEAT_MT_MOONB2F_TRAINER_2
	const EVENT_BEAT_MT_MOONB2F_TRAINER_3
	const EVENT_BEAT_MT_MOONB2F_ROCKET_JERRY
	const EVENT_57E
...
DEF SS_ANNE_5_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 11
DEF SS_ANNE_8_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 12
DEF SS_ANNE_9_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 12
DEF SS_ANNE_10_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF VICTORY_ROAD_3_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Rocket Hideout events
	const_next $670
	const_skip 1
DEF ROCKET_HIDEOUT_1_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const EVENT_67F ; ???
	const_skip 1
DEF ROCKET_HIDEOUT_2_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_ROCKET_HIDEOUT_2_TRAINER_0
	const_skip 15
DEF ROCKET_HIDEOUT_3_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF ROCKET_HIDEOUT_4_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const EVENT_BEAT_ROCKET_HIDEOUT_JERRY

; Silph Co. events
	const_next $6F0
	const_skip 2
DEF SILPH_CO_2F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 2
DEF SILPH_CO_3F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 8
DEF SILPH_CO_4F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 8
DEF SILPH_CO_5F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 11
DEF SILPH_CO_6F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 4
DEF SILPH_CO_7F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 3
DEF SILPH_CO_8F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 9
DEF SILPH_CO_9F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const_skip 5
DEF SILPH_CO_10F_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF SILPH_CO_11F_TRAINER_EVENT_OFFSET EQU const_value % 8
	...
	const EVENT_BEAT_SILPH_CO_ROCKET_JERRY

; Pokémon Mansion events
	const_next $800
	const_skip 1
DEF POKEMONMANSION_2F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONMANSION_2F_TRAINER_0
	const_skip 15
DEF POKEMONMANSION_3F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONMANSION_3F_TRAINER_0
	const EVENT_BEAT_POKEMONMANSION_3F_TRAINER_1
	const_skip 14
DEF POKEMONMANSION_B1F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const EVENT_BEAT_POKEMONMANSION_B1F_TRAINER_0
	const EVENT_BEAT_POKEMONMANSION_B1F_TRAINER_1
...
; Cerulean Cave events
	const_next $8C0
	const_skip 1
DEF CERULEAN_CAVE_TRAINER_EVENT_OFFSET EQU const_value % 8
...
DEF INDIGO_PLATEAU_EVENTS_START EQU const_value
	const_skip 1
DEF LORELEIS_ROOM_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Victory Road 1F events
	const_next $910
	const_skip 1
DEF VICTORY_ROAD_1_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Rock Tunnel events
	const_next $9B0
	const_skip 1
DEF ROCK_TUNNEL_B1F_TRAINER_EVENT_OFFSET EQU const_value % 8
...
; Seafoam Islands events
	...
	const_skip 1
DEF SEAFOAM_ISLANDS_B1F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const_skip 5
	const EVENT_SEAFOAM3_BOULDER1_DOWN_HOLE
	const EVENT_SEAFOAM3_BOULDER2_DOWN_HOLE
	const_skip 1
DEF SEAFOAM_ISLANDS_B2F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const_skip 5
	const EVENT_SEAFOAM4_BOULDER1_DOWN_HOLE
	const EVENT_SEAFOAM4_BOULDER2_DOWN_HOLE
	const_skip 1
DEF SEAFOAM_ISLANDS_B3F_TRAINER_EVENT_OFFSET EQU const_value % 8
	const_skip 7
DEF SEAFOAM_ISLANDS_B4F_TRAINER_EVENT_OFFSET EQU const_value % 8
