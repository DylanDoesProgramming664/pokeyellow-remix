...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_FLASH_CANNON, TM_TRI_ATTACK, TM_MIMIC, TM_DIG, TM_PSYWAVE, TM_METRONOME, TM_SKULL_BASH
