...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_EDITOR, CRED_DYLAN, CRED_TEXT_FADE_MON

	; Pokemon Yellow Legacy Credits
	db CRED_POKEMON, CRED_LEGACY, CRED_TEXT_FADE_MON
	...
	; Original Credits
	db CRED_POKEMON, CRED_VERSION, CRED_TEXT_FADE
