...
ViridianCityHS:
	...
	db VIRIDIAN_CITY, VIRIDIANCITY_POTION,         SHOW
PewterCityHS:
...
Route10HS:
	db ROUTE_10, ROUTE10_ROCKET_JERRY,  SHOW
Route12HS:
...
MtMoonB2FHS:
	...
	db MT_MOON_B2F, MTMOONB2F_ROCKET_JERRY,  SHOW
SSAnne2FHS:
...
VictoryRoad3FHS:
	...
	db VICTORY_ROAD_3F, VICTORYROAD3F_TM_SHADOW_CLAW, SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_STONE_EDGE, SHOW
