...
; Route 6
	db 23, BUTTERFREE, BEEDRILL, VENONAT, 0
...
;+Route 25
	db 20, WARTORTLE, 0
; Route 6
	db 21, MANKEY, RATICATE, 0
;+Route 6
	db 21, DIGLETT, DIGLETT, SANDSHREW, 0
	db 21, GROWLITHE, CHARMELEON, VULPIX, 0
; Route 9
	db 21, RATICATE, DIGLETT, BELLSPROUT, SANDSHREW, 0
; Route 12
	db 29, NIDOQUEEN, NIDOKING, 0
; Route 6
	db 21, HORSEA, WEEPINBELL, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 21, RATICATE , 22, WEEPINBELL, 22, SANDSLASH, 23, FEAROW, 21, KADABRA, 24, EEVEE, 0
; Pokémon Tower 2F
	db $FF, 34, FEAROW, 32, SHELLDER, 32, GROWLITHE, 32, WEEPINBELL, 33, KADABRA, 35, JOLTEON,  0
	db $FF, 34, FEAROW, 32, MAGNETON, 33, KADABRA, 32, SHELLDER, 32, PINSIR, 35, FLAREON, 0
	db $FF, 34, FEAROW, 32, VULPIX, 32, MAGNETON, 33, KADABRA, 32, SCYTHER, 35, VAPOREON, 0
; Silph Co. 7F
